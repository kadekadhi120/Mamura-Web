    ...
    <section class="slider_section ">
          <div class="container ">
            ...
            <div class="d-flex flex-column align-items-center"></div>
              ...
              <div class="col-md-6">
                <div class="img-box">
                  <img src="{{ asset('images/custpage.png') }}" alt="">
                </div>
              </div>
            </div>
              </div>
  ...
  <section class="cp_section layout_padding">
    <div class="container text-center ">
      ...
      <div class="row">
        ...
        <a class="navbar-brand" href="{{ url('/nasi') }}">
          <div class="card">
            <div class="card-body">
                <img src="{{ asset('images/nasi.png') }}" class="card-img-top" alt="...">
        ...
        <div class="col-sm-3">
          ...
          <div class="card">
            <div class="card-body">
                <img src="{{ asset('images/snack.webp') }}" class="card-img-top" alt="...">
        ...
        <div class="col-sm-3">
            ...
            <div class="card">
              <div class="card-body">
                  <img src="{{ asset('images/dessert.png') }}" class="card-img-top" alt="...">
          ...
          <div class="col-sm-3">
            ...
            <div class="card">
              <div class="card-body">
                  <img src="{{ asset('images/bakery.png') }}" class="card-img-top" alt="...">
      ...
      <div class="row">
        <div class="col-sm-3">
            ...
            <div class="card">
              <div class="card-body">
                  <img src="{{ asset('images/daging.png') }}" class="card-img-top" alt="...">
          ...
          <div class="col-sm-3">
            ...
            <div class="card">
              <div class="card-body">
                  <img src="{{ asset('images/ayam.png') }}" class="card-img-top" alt="...">
          ...
          <div class="col-sm-3">
            ...
            <div class="card">
              <div class="card-body">
                  <img src="{{ asset('images/sayur.png') }}" class="card-img-top" alt="...">
          ...
          <div class="col-sm-3">
            ...
            <div class="card">
              <div class="card-body">
                  <img src="{{ asset('images/beverages.png') }}" class="card-img-top" alt="...">
